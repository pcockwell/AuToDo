...
-- Create a dummy table to avoid lock errors.
CREATE TABLE IF NOT EXISTS `fixed_events` ( `id` int(11) );
CREATE TABLE IF NOT EXISTS `tasks` ( `id` int(11) );
CREATE TABLE IF NOT EXISTS `users` ( `user_id` int(11) );
